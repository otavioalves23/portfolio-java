...
public class JurosCompostos extends JDialog {
	...
	public JurosCompostos() {
		...
		setModal(true);
		setIconImage(Toolkit.getDefaultToolkit().getImage(JurosCompostos.class.getResource("/img/cep-48.png")));
		setResizable(false);
		...
		btnCalcular.setIcon(new ImageIcon(JurosCompostos.class.getResource("/img/calculator.png")));
